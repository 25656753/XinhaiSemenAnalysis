 ...
 * 4. 退出并注销监听
 */
public class ActivityGuideDeviceListAP extends ActivityDemo implements OnClickListener, OnFunDeviceListener, ListAdapterFunDevice.OnFunDeviceItemClickListener, WifiStateListener, OnAddSubDeviceResultListener {
