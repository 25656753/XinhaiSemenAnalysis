package com.xinhai.xinhaisemenanalysis.devices.settings;
...
public class ActivityGuideDeviceSPVMNCfgJson extends ActivityDemo implements View.OnClickListener, IFunSDKResult {
	...
	private void initLayout() {
		mServerOpenImgBtn = (ImageButton) findViewById(R.id.img_setup_server_open_btn);
		mServerOpenImgBtn.setOnClickListener(this);

		mOutAlarmOpenImgBtn = (EditText) findViewById(R.id.img_setup_outalarm_open_btn);
		mVideoDismissImgBtn = (EditText) findViewById(R.id.img_setup_video_dismiss_btn);
		mMotionMoveImgBtn = (EditText) findViewById(R.id.img_setup_motion_move_btn);
		mScreenOcclusionImgBtn = (EditText) findViewById(R.id.img_setup_screen_occlusion_btn);
		mSystemAbnormalityImgBtn = (EditText) findViewById(R.id.img_setup_system_abnormality_btn);
		mUserConnectImgBtn = (EditText) findViewById(R.id.img_setup_user_connect_btn);
